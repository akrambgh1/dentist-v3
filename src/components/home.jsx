  ...
  return (
    <>
      ...
      <section className="flex flex-col min-h-screen gap-[2rem] mb-[5rem]">
        ...
        <section className="flex flex-col p-4">
          ...
          <div className="flex flex-col gap-[1rem]">
            ...
            <Card
              ...
              description="Easily browse a network of professional dentists, view their specialties, and choose the one that best fits your needs. No more guessing—just the right care at the right time."></Card>

            <Card
              icon={Calendar}
              title="Book Appointments Seamlessly"
              description="Forget long wait times and phone calls. Schedule your dental visits with just a few clicks, and get reminders so you never miss an appointment."></Card>
          </div>
          ...
          <div className="flex flex-col gap-[1rem] mt-[1rem]">
            ...
            <Card
              ...
              description="Dentists can create a professional profile, highlight their skills, and attract more patients by building trust and credibility."></Card>

            <Card
              icon={NotebookPen}
              title=" Manage Your Schedule"
              description="Keep your calendar organized with a simple, intuitive booking system. Set your availability, confirm appointments, and focus on what you do best—caring for your patients."></Card>
          </div>
        </section>

        <section className="w-full px-4 py-8 bg-[#181940] text-center flex flex-col justify-center items-center gap-[1rem]">
          <h1 className="text-white text-[1.5rem] font-[600]">
            Join today and experience the future of dental care.
          </h1>
          <Link to="/login">
        ...
        <div className="w-full mb-[2rem] text-center">
          © Dentist. All rights reserved.
        </div>
      </section>
    </>
  );
